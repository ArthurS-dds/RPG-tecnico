...
print("Números menores de 15:")for n in numeros:    if n <= 15:        print(n, end=' ')print()  
contagem = 0for n in numeros:    if n <= 15 and n % 2 == 0:        contagem += 1
print("Quantidade de números pares =", contagem)

------------------------------------------------------------------------------------------------------------------

3) lista = (1, 2)
def soma_lista(lista):    total = 0    for num in lista:        total += num    return total
